...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        ...
        fetchTodo: function(){
            if (this.currentUser) {
                var query = new __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.Query('Todos')
        ...
        updateTodo: function(){
            ...
            let avTodos = __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.Object.createWithoutData('Todos', this.list.id)
        ...
        saveTodo: function(){
            let dataString = JSON.stringify(this.list)
            let Todos = __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.Object.extend('Todos')
            let todos = new Todos()
            todos.set('data', dataString)
            let acl = new __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.ACL()  // 新建ACL实例
            acl.setReadAccess(__WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.User.current(),true)  // 只有此user可读
            acl.setWriteAccess(__WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.User.current(),true)  // 只有此user可写
